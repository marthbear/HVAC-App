  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        "Go to More > Manage Team, then tap the 'Add Employee' button. Fill in their information including name, email, role, and contact details. They will receive an invitation to set up their account.",
    },
    {
      id: "2",
      question: "How do I schedule a service job?",
      answer:
        "Navigate to the Schedule tab and select the date. Tap the '+' button to create a new job, then fill in the customer information, service type, time, and assign it to an employee.",
    },
    {
      id: "3",
      question: "Can I export reports?",
      answer:
        "Yes! Go to More > Reports and tap the export buttons at the bottom. You can export reports as PDF or Excel files, or email them directly from the app.",
    },
    {
      id: "4",
      question: "How do I update company information?",
      answer:
        "Navigate to More > Company Settings. Here you can update your company name, address, contact information, business hours, and billing settings.",
    },
    {
      id: "5",
    ...
    {
      id: "6",
      question: "How do I enable emergency service?",
      answer:
        "Go to More > Company Settings > Service Settings and toggle on '24/7 Emergency Service'. This allows customers to request emergency services outside of business hours.",
    },
  ];
